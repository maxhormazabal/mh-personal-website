import{T as c}from"./ViewTransitions.astro_astro_type_script_index_0_lang.s-lHDr_u.js";import{b as m,w as y,e as v}from"./content.DXmGIyis.js";function i(){const e=localStorage.getItem("mh-lang")||"en",a=c[e],d=document.getElementById("about-heading");d&&(d.textContent=a.about_heading);const r=document.getElementById("about-quote");r&&(r.textContent=a.about_quote);const s=document.getElementById("work-heading");s&&(s.textContent=a.work_heading);const p=document.getElementById("edu-heading");p&&(p.textContent=a.edu_heading);const l=document.getElementById("bio-container");if(l){const t=m[e];l.innerHTML=t.map((n,o)=>`
