import{T as y}from"./ViewTransitions.astro_astro_type_script_index_0_lang.s-lHDr_u.js";import{c as m}from"./content.DXmGIyis.js";function a(){const s=localStorage.getItem("mh-lang")||"en",e=y[s],r=document.getElementById("teaching-heading");r&&(r.textContent=e.teaching_heading);const l=document.getElementById("teaching-sub");l&&(l.textContent=e.teaching_sub);const p=document.getElementById("philosophy-heading");p&&(p.textContent=e.philosophy_heading);const d=document.getElementById("about-quote");d&&(d.textContent=e.about_quote);const c=document.getElementById("courses-heading");c&&(c.textContent=e.courses_heading);const x=document.getElementById("courses-container");if(x){const n=m[s],o=t=>`
